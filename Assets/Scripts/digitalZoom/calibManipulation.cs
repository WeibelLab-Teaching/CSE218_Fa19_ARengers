...
{
    public class calibManipulation : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusChangedHandler
    {
        #region Public Enums
        ...
        // setting
        private HandMovementType manipulationType = HandMovementType.OneHandedOnly;
